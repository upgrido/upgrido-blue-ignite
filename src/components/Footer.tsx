    ...
    <footer className="py-16 px-4 border-t border-border/30">
      <div className="max-w-lg mx-auto">
        ...
        <div className="flex justify-center gap-4 mb-8">
          <a href="https://instagram.com/sekhar.polinaa" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-card card-border flex items-center justify-center hover:bg-muted transition-colors">
          ...
          <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-card card-border flex items-center justify-center hover:bg-muted transition-colors">
        ...
        <div className="grid grid-cols-2 gap-8 mb-10">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {["Home", "Hire from us", "404"].map((link) => (
                <li key={link}>
